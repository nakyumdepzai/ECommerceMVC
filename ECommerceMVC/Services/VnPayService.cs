...
namespace TimeShareWebProject.Services
{
...

    {
        ...
        {
            //var tick = DateTime.Now.GetHashCode().ToString();
            ...
            vnpay.AddRequestData("vnp_OrderInfo", "Pay for" + model.OrderId);
            vnpay.AddRequestData("vnp_OrderType", "Other"); //default value: other
            vnpay.AddRequestData("vnp_ReturnUrl", _config["VnPay:PaymentBackReturnUrl"]);
            vnpay.AddRequestData("vnp_TxnRef", model.OrderId + tick); // Mã tham chiếu của giao dịch tại hệ thống của merchant. Mã này là duy nhất dùng để phân biệt các đơn hàng gửi sang  trùng lặp trong ngày
